...
<style>
	...
	/*a{display:block;width:100px;height:30px;background-color:#999999; border:1px solid #333333;}*/
...
<%
	...
	strSQL += " FROM GUESTS ORDER BY IDX DESC";
	PreparedStatement iPsmt = con.prepareStatement(strSQL);
